...
$hasil = mysqli_query("SELECT * FROM pasien WHERE kode_pasien = $kode_pasien");
 
//mengambil data dari table ruangan yg sesuai dengan pilihan user
$hasil2 = mysqli_query("SELECT * FROM ruangan WHERE kode_pasien = '$kode_pasien'");

////mengambil data dari table tgl_masuk yg sesuai dengan pilihan user
$hasil3 = mysqli_query("SELECT tgl_masuk FROM tgl_masuk WHERE kode_pasien = '$kode_pasien'");

//mengambil data kode ruangan dari database
$ruang = mysqli_query("SELECT kode_ruangan FROM ruangan"); 

//memecah hasil query ke dalam array
$baris = mysqli_fetch_array($hasil); //array dari tabel pasien
$baris2 = mysqli_fetch_array($hasil2); //array dari tabel ruangan
$baris3 = mysqli_fetch_array($hasil3); //array dari tabel tgl_masuk
echo mysqli_error(); //tampilkan instruksi jika terjadi error
?>
<div align="center">
