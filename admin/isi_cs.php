...
$insert = mysqli_query("INSERT INTO cleaning_service (kode_clean_serv, kode_ruangan, nama_clean_serv, alamat_clean_serv, no_tlp) VALUES('$kodecs','$kode_ruangan','$nama_cs','$alamat','$no_tlp')");
