...
$sql = mysqli_query("SELECT * FROM suster ORDER BY kode_suster");
...
<table width="638" height="27" border="1" align="center">
 ...
 <?php
 $warna='';
while ($suster = mysqli_fetch_array($sql)){
...
$sql2 = mysqli_query("SELECT nama_dokter FROM dokter WHERE kode_dokter = $suster[kode_dokter]");
$dokter = mysqli_fetch_array($sql2);//pecah hasil query ke dalam array
