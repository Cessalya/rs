...
$query = mysqli_query("SELECT * FROM jadwal_jaga ORDER BY kode_jaga");
...
$dok = mysqli_query("SELECT nama_dokter FROM dokter WHERE kode_dokter = '$jadwal[kode_dokter]'");
$dokter = mysqli_fetch_array($dok);
echo "<td>$dokter[nama_dokter]</td>";
$sus = mysqli_query("SELECT nama_suster FROM suster WHERE kode_suster = '$jadwal[kode_suster]'");
$suster = mysqli_fetch_array($sus);
echo "<td>$suster[nama_suster]</td>";
$rec = mysqli_query("SELECT nama_receptionist FROM receptionist WHERE kode_receptionist = '$jadwal[kode_receptionist]'");
$recept = mysqli_fetch_array($rec);
