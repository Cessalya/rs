...
$kode_masuk_maks = mysqli_query("SELECT MAX(kode_masuk) AS maks FROM tgl_masuk");
$kode_maks = mysqli_fetch_array($kode_masuk_maks);//memecah hasil kedalam array
...
$hasil = mysqli_query("INSERT INTO pasien VALUES('$kode_pasien', '$nama_pasien', '$tgl_lahir', '$tempat_lahir', '$jenis_kelamin', '$alamat', '$usia', '$penyakit')");

//query untuk memasukkan data ke dalam tabel tgl_masuk
$hasil2 = mysqli_query("INSERT INTO tgl_masuk VALUES('$kode_masuk','$kode_pasien','$kode_dokter','$ruangan','$tgl_masuk')");

////query untuk memasukkan data ke dalam tabel ruangan
$hasil3 = mysqli_query("INSERT INTO ruangan VALUES('$ruangan','$kode_pasien','$nama_ruangan','$jenis_ruangan','$no_ranjang')");

//query untuk memasukkan data ke dalam tabel rawat_inap
$hasil4 = mysqli_query("INSERT INTO rawat_inap VALUES('$kode_inap','$kode_pasien','$kode_dokter','$ruangan')");
/*
...
echo "gagal 1:  ".mysqli_error();//tapi jika gagal maka tampilkan kesalahan query
} */
?>
