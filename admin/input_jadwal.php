...
$query1 = mysqli_query("SELECT nama_dokter FROM dokter");//mengambil nama dokter
$query2 = mysqli_query("SELECT nama_suster FROM suster");//mengambil nama suster
$query3 = mysqli_query("SELECT nama_receptionist FROM receptionist");//mengambil nama receptionist

//mengambil kode_jaga dari 
$ambil = mysqli_query("SELECT MAX(kode_jaga) AS kode_jaga FROM jadwal_jaga");
$kode = mysqli_fetch_array($ambil);
