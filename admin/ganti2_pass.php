...
$query1 = mysqli_query("SELECT password FROM receptionist WHERE password = '$pwd_lama'");
$kode = $_SESSION[username];
$lama = mysqli_num_rows($query1);
echo mysqli_error();
...
$update = mysqli_query("UPDATE receptionist SET password = md5('$confirm') WHERE kode_receptionist='$kode'");
