...
$query = mysqli_query("SELECT nama_dokter FROM dokter");

//mengambil data dari tabel suster
$hasil = mysqli_query("SELECT * FROM suster WHERE kode_suster = '$kode_suster'");
$suster = mysqli_fetch_array($hasil);

//mengambil nama dokter awal
$querylagi = mysqli_query("SELECT nama_dokter FROM dokter WHERE kode_dokter = '$suster[kode_dokter]'");
$dokter_awal = mysqli_fetch_array($querylagi);
?>
